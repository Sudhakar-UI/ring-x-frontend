                ...
                <Container className="sitecontainer transferpage">
                    <div className="flexbox">
                        <div className="panelcontentbox">
                            <h2 className="heading-box pt-0 mb-0 ps-0">Transfer</h2>
                            <Form className="siteformbg">
                                ...
                                <p><span className="t-gray">Available Main Wallet Balance</span><span className="t-black pull-right">0 <span className="text-uppercase"></span></span></p>
                                <p><span className="t-gray">Available P2P Wallet Balance</span><span className="t-black pull-right">0 <span className="text-uppercase"></span></span></p>
                                <p className="content">
                                  Transfer between Main wallet and P2P are considered internal and completely free of charge. These transactions are executed instantly. so you can move your funds seamlessly.These transactions are executed instantly. so you can move your funds seamlessly.
                                </p>
                            </Form>
