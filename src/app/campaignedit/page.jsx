...
import { faArrowLeft, faEye, faAngleDoubleRight } from '@fortawesome/free-solid-svg-icons';
...
const Campaigncreate = () => {
	...
	return (
		<div className="pagecontent gridpagecontent innerpagegrid campaignedit-page">
			<Userheader />
			<Leftsidemenu />
															...
															<tr>
																<td colSpan={2}>
																	<Table className="sitetable">
																		<tbody>
																			<tr>
																				<td className="t-gray">Type:</td>
																				<td className="text-end"><span className="t-black">
																					<div className="shortnotes">per Click</div>
																				</span></td>
																			</tr>
																			<tr>
																				<td className="t-gray">Commission:</td>
																				<td className="text-end"><span className="t-black">$0.20</span></td>
																			</tr>
																			<tr>
																				<td className="t-gray">2nd tier commission:</td>
																				<td className="text-end"><span className="t-black">$0.15</span></td>
																			</tr>
																			<tr>
																				<td className="t-gray">3rd tier commission:</td>
																				<td className="text-end"><span className="t-black">$0.15</span></td>
																			</tr>
																			<tr>
																				<td className="t-gray">4th tier commission:</td>
																				<td className="text-end"><span className="t-black">$0.20</span></td>
																			</tr>
																			<tr>
																				<td className="t-gray">5th tier commission:</td>
																				<td className="text-end"><span className="t-black">$0.20</span></td>
																			</tr>
																			<tr>
																				<td className="t-gray">Action:</td>
																				<td className="text-end"><div className="d-">
																					<Button onClick={handleShow2} id="editbtn" className="btn borderbtn green-btn btn-sm me-2">Edit</Button>
																					<Button id="disablebtn" className="btn borderbtn red-btn btn-sm ">Disable</Button>
																				</div></td>
																			</tr>
