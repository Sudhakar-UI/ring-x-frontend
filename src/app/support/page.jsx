        ...
        <div className="pagecontent gridpagecontent innerpagegrid">
            ...
            <div className="innerpagecontent">
                <Container className="sitecontainer">
                    ...
                    <div className="tabrightbox"> <button onClick={handleShowModal1} className="btn-sm sitebtn">Create Tickets</button> </div>
                </Container>
            </div>
                                  ...
                                  <div className="panelcontentbox chatticketlist">
                                    <Tab.Content>
                                        <Tab.Pane eventKey="first">
                                            <div className="d-flex align-items-center justify-content-between heading-box pt-0 flex-wrap gap-1">
                                                <h1 className="heading-box p-0 border-0">Ticket ID : EX6276648</h1>
