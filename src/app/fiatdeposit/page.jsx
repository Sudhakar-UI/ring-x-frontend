    ...
    return (
        ...
        <div className="pagecontent gridpagecontent innerpagegrid">
            ...
            <div className="innerpagecontent d-flex align-items-center justify-content-between">
                <h2 className="h2 text-start"> Deposit Fiat</h2>
                    ...
                    <div className="flexboxtable">
                        ...
                        <div className="trendcoinbox mt-0 panelcontentbox">
                            ...
                            <div className="hwtbg">
                                ...
                                <p>Choose the fiat currency you want to deposit.</p>
                                ...
                                <p>Enter the exact amount you deposited, ensuring it matches the amount shown in the uploaded receipt.</p>
