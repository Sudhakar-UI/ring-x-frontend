...
const Promoterview = () => {
	...
	return (
		<div className="pagecontent gridpagecontent innerpagegrid promoterviewpage">
			<Userheader />
			<Leftsidemenu />
			...
			<article className="gridparentbox">
				<Container className="sitecontainer promoterview-container">
					...
					<div className="panelcontentbox mt-3 rxt-wrapper-bg">
