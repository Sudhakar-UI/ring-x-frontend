...
const Affiliatetracking = () => {
	...
	return (
		<div className="pagecontent gridpagecontent innerpagegrid affiliatetrackingpage">
			<Userheader />
			<Leftsidemenu />
				...
				<Container className="sitecontainer">
					<div className="overviewbalancebox panelcontentbox adsblancebox rxt-wrapper-bg">
						<div className=' d-flex align-items-center justify-content-between flex-wrap'>
							<h2 className="heading-box  mb-0 p-3">Tracking Details</h2>
							...
							<div className="walletbalancebox">
								<div className="tablebox d-flex">
									...
									<div className="balancetableb panelcontentbox">
										<div className="balanceshowt table-content">
											<div>
												<h5 className="h5">Total Amout</h5>
					...
					<div className="panelcontentbox mt-3">
						<h2 className="heading-box pt-0 p-0">Promoter Performance</h2>
