...
const Affiliateperformance = () => {
	...
	return (
		<div className="pagecontent gridpagecontent innerpagegrid affiliateperformance-page">
			<Userheader />
			<Leftsidemenu />

			<div className="innerpagecontent">
				<Container className="sitecontainer">
					<h2 className="h2">Affiliate Performance</h2>

					<div className="overviewbalancebox panelcontentbox adsblancebox mt-3">
