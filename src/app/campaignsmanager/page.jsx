...
const Advertiserdashboard = () => {
	...
	return (
		<div className="pagecontent gridpagecontent innerpagegrid campaignsmanagerpage">
			<Userheader />
			<Leftsidemenu />
			...
			<article className="gridparentbox">
				...
				<div className="panelcontentbox campaignmangepage">
					<div className=' d-flex align-items-center justify-content-between'>
						<h2 className="heading-box pt-0 ps-0 mb-0 p-0">List of Campaign</h2>
					<Link href="/campaigncreate" className='sitebtn borderbtn btn-sm'>Create Campaign</Link>
					</div>
					{/* <div className="tabrightbox">
					...
					<Table className="sitetable table-responsive-stack" id="table1">
						...
						<tbody>
							<tr>
								...
								<td>3/30/2026, 7:55:43 PM</td>                    
								<td className="flxcahbtn">
								<div className="d-flex">
									<Link href="/campaignedit" id="edit" className="btn borderbtn green-btn btn-sm me-2">Edit Campaign</Link>
									<Link href="/campaignedit" id="edit" className="btn borderbtn green-btn btn-sm me-2">Edit Commission</Link>
									<Link href="#" id="lock" className="btn borderbtn red-btn btn-sm me-2">Add Budget</Link>
									{/* <Link href="#" id="copy" className="btn borderbtn btn-sm">Copy</Link> */}
								</div>
								</td>
							</tr>
							{/* <tr>
