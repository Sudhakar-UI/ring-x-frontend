...
const Affiliateviewstats = () => {
	...
	// 				[Date.UTC(2023, 0, 1, 4, 0), 1],   
	// 				[Date.UTC(2023, 0, 1, 8, 0), 4],  
	// 				[Date.UTC(2023, 0, 1, 12, 0), 4],  
	// 				[Date.UTC(2023, 0, 1, 16, 0), 5],  
	// 				[Date.UTC(2023, 0, 1, 20, 0), 2],  
	// 				[Date.UTC(2023, 0, 1, 23, 59), 3]  
	// 			]
	// 		}]
	// 	})
	...
	return (
		<div className="pagecontent gridpagecontent innerpagegrid">
			...
			<article className="gridparentbox affstatspage">
				...
				<h2 className="heading-box pt-0 ps-2 border-0">Click Report</h2>
